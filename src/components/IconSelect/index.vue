<template>
  <div ref="iconSelectRef" :style="'width:' + width" class="relative">
    ...
    <el-popover :popoverVisible="popoverVisible" placement="bottom-end" trigger="click" :width="width">
      <template #reference>
        <div class="cursor-pointer text-[#999] absolute-rt height-[32px] leading-[32px] px-1"
          ...
          <el-tab-pane label="SVG 图标" name="svg">
            <el-scrollbar height="300px">
              <ul class="flex flex-wrap">
                <li v-for="(icon, index) in filteredSvgIcons" :key="'svg-' + index" class="icon-item"
...
const activeTab = ref("svg"); // 默認激活的Tab
