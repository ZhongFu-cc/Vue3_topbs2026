    ...
    <el-dialog v-model="dialog.visible" :title="dialog.title" width="500px" @close="closeDialog">
      <el-form ref="roleFormRef" :model="formData" :rules="rules" label-width="100px">
        <el-form-item label="角色名称" prop="name">
          <el-input v-model="formData.name" placeholder="請輸入角色名称" />
        </el-form-item>

        <el-form-item label="角色编码" prop="code">
          <el-input v-model="formData.code" placeholder="請輸入角色编码" />
        </el-form-item>
...
const rules = reactive({
  name: [{ required: true, message: "請輸入角色名称", trigger: "blur" }],
  code: [{ required: true, message: "請輸入角色编码", trigger: "blur" }],
